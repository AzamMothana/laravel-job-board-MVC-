...
<form method="POST" action="/blog/{{ $post->id }}">
    ...
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            <h2 class="text-base/7 font-semibold text-gray-900">Edite post : "{{ $post->title }}"</h2>
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input id="title" value="{{  old('title', $post->title)  }}" type="text" name="title" autocomplete="given-name"
                    ...
                    <div class="flex gap-3">
                        <div class="flex h-6 shrink-0 items-center">
                            <div class="group grid size-4 grid-cols-1">
                                <input  id="published" type="checkbox" value="1" {{ old('published' || (!old() && $post->published)) ? 'checked' : ''}} name="published" 
